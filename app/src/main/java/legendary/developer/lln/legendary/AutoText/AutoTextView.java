package legendary.developer.lln.legendary.AutoText;
...
import legendary.developer.lln.legendary.Callback.Callback;
...
public class AutoTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public String misstakeValues = "1234567890";
    ...
    public void animateDecryption(final String text) {
        ...
        if(!executed) {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    AutoTextViewRequester requester = new AutoTextViewRequester((OnAutoTextView) getContext());
                    requester.execute();
                }
            }, 2000);
